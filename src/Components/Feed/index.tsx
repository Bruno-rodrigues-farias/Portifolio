...
export default function Feed() {
    return (
        <div className="bg-gradient-to-b from-slate-950 via-slate-900 to-slate-600 min-h-screen flex flex-col items-center justify-start p-8 gap-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full mt-28 px-16">
                {/* Texto com animação */}
                <div className="text-white text-lg md:text-3xl font-bold max-w-md leading-relaxed opacity-0 translate-y-10 animate-fade-in w-full md:w-2/3 ml-44">
                    Olá! Meu nome é Bruno Rodrigues, tenho 27 anos, sou estudante de Analise e Desenvolvimento de Sistemas na Faculdade Cearense, programador fullStack e sou apaixonado por tecnologia. Sempre tive curiosidade por entender como as coisas funcionam, o que despertou em mim o desejo de explorar o mundo da programação.
                </div>

                {/* Cartão com animação */}
                <div className="transform opacity-0 animate-slide-up rounded-lg">
                    <div className="flex items-center justify-center w-[600px] h-[600px] rounded-full overflow-hidden shadow-lg bg-gray-800">
                        <Image
            ...
            <div className="text-white text-lg md:text-3xl font-bold max-w-4xl leading-relaxed opacity-0 translate-y-10 animate-fade-in mt-60">
                ...
                <div className="flex flex-wrap gap-8 mt-8 justify-center">
                    {[
                        ...
                        >
                            <div className="w-28 h-28 bg-gray-800 rounded-full flex items-center justify-center overflow-hidden">
                                <img
                                    src={skill.image}
                                    alt={skill.name}
                            ...
                            <span className="absolute -bottom-7 text-slate-300 text-sm font-semibold">
                            {skill.name}
                            </span>
